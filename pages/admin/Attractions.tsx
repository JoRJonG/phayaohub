...
import { Plus, Edit2, Trash2, MapPin, Eye, Star, ImageIcon } from 'lucide-react';
...
const AdminAttractions: React.FC = () => {
    ...
    const fetchGuides = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/admin/guides?category=เที่ยว', {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(url, {
                ...
                body: JSON.stringify({ ...formData, image_url: uploadedImageUrl, category: 'เที่ยว' })
            });
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">จัดการสถานที่ท่องเที่ยว</h1>
                    <p className="text-slate-500">จัดการข้อมูลสถานที่ท่องเที่ยวในพะเยา</p>
                </div>
                <button
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] flex flex-col">
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                            <h2 className="text-xl font-bold text-slate-800">
                                {isEditing ? 'แก้ไขสถานที่ท่องเที่ยว' : 'เพิ่มสถานที่ท่องเที่ยว'}
                            </h2>
                        ...
                        <div className="overflow-y-auto p-6">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 mb-1">ชื่อสถานที่ *</label>
                                    <input
                                        type="text"
                                        required
                                ...
                                <div className="flex items-center gap-4">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        ...
                                        />
                                        <span className="text-sm text-slate-700">แสดงเป็นสถานที่แนะนำ</span>
                                    </label>
                                </div>
                                <div>
