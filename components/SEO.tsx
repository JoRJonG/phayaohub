...
const SEO: React.FC<SEOProps> = ({
    title = 'Phayao Hub | รวมของมือสองพะเยา ท่องเที่ยว และหางานพะเยา',
    description = 'ศูนย์รวมข้อมูลจังหวัดพะเยา แหล่งซื้อขายของมือสองพะเยา สินค้า OTOP สถานที่ท่องเที่ยว ร้านอาหาร และหางานในพะเยา',
    keywords = 'ของมือสองพะเยา, ขายของมือสองพะเยา, พะเยา, จังหวัดพะเยา, ท่องเที่ยวพะเยา, ร้านอาหารพะเยา, ที่พักพะเยา, งานพะเยา, ตลาดซื้อขายพะเยา, Phayao Hub',
