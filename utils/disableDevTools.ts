...
export const disableDevTools = () => {
    ...
    // 1. ป้องกันการเปิด DevTools ด้วย keyboard shortcuts (ปิดการใช้งาน)
    ...
    // 2. ป้องกันการคลิกขวา (Right Click) - ปิดการใช้งาน
    // document.addEventListener('contextmenu', (e) => {
    //     e.preventDefault();
    //     return false;
    // });

    // 3. ตรวจจับการเปิด DevTools โดยการวัดความกว้างของ console (ปิดการใช้งาน)
    ...
    // 4. ตรวจจับการเปิด DevTools ด้วย debugger statement (ปิดการใช้งาน)
    ...
    // เรียกใช้งานการตรวจจับทุกๆ 1 วินาที (ปิดการใช้งาน)
    ...
    // 7. Clear console ทุกๆ 100ms (ปิดการใช้งาน)
    // setInterval(() => {
    //     console.clear();
    // }, 100);

    // 8. Override console methods (ปิดการใช้งาน)
    // const noop = () => { };
